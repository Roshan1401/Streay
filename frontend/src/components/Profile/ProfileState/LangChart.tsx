...
export default function LangChart() {
  ...
  return (
    <div className="h-auto w-full rounded-xl border border-(--color-border) bg-white dark:bg-[#1b1718]/50">
      <div className="flex flex-col p-6 md:flex-row md:items-center md:justify-between md:px-7 md:py-3">
        <div className="flex flex-col justify-between gap-2 md:justify-normal md:gap-0">
        ...
        <div className="mt-3 flex w-fit flex-row items-center gap-2 rounded-lg border border-neutral-700 bg-neutral-900 p-1.5 md:gap-0 md:rounded-full">
          {charts.map((chart) => (
            <button
              key={chart}
              type="button"
      ...
      <div className="grid grid-cols-1 gap-10 overflow-hidden px-4 py-6 sm:px-6 sm:py-12 lg:grid-cols-2 lg:gap-8">
